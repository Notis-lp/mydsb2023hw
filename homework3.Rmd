...
temp2 <- left_join(temp,urban_rural2,by=c('res_state'='state_abr'))
#calculating the percentage for each category
temp2 <- temp2 %>% 
...
#plotting
p <- ggplot(temp2,aes(x=case_month, y=perc, color=type))+
  geom_line()+
...
ggplot(temp,aes(x=case_month, y=perc, color=type))+
  geom_line()+
  scale_y_continuous(labels = scales::percent)+
