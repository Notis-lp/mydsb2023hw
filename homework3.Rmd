...
contrib00 <- scrape_pac(url00)
contrib20 <- scrape_pac(url20)
contrib22 <- scrape_pac(url22)
```
...
urls[1]
map(.urls,~paste("https://www.opensecrets.org/political-action-committees-pacs/foreign-connected-pacs/",
             as.character(.url),sep=""))
```
